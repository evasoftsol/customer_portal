...
const BaseHoc = (Component) => ({ ...props }) => {
    ...
    if (!localStorage.getItem("customerName")) {
        ...
        console.log("route in else is=" + route + " report " + localStorage.getItem("isReportActive"));

        if (localStorage.getItem("isReportActive") === "true") {
                ...
                <>
                    <div className="flex flex-col sm:flex-row justify-center w-screen h-screen">
                        ...
                        (<div className="hover:text-black w-3/4 flex flex-row justify-start gap-4 align-center rounded-lg p-3 ">
                            ...
                            {route === "/report" ?
                                (<div className="w-full border-r-2 border-sky-600">
                                    <div className="hover:text-black !text-black min-w-min w-3/4 flex flex-row justify-start gap-4 align-center rounded-lg bg-[#EFF2FE] p-3 ">
                                        <div className="!text-xl"><ImClipboard /></div>
                                        <Link to="/report" >Trend Chart</Link>
                                    </div></div>) :
                                (<div className="hover:text-black w-3/4 flex flex-row justify-start gap-4 align-center rounded-lg p-3 ">
                                    <div className="!text-xl"><ImClipboard /></div>
                                    <Link to="/report" >Trend Chart</Link>
                            ...
                            {route === "/report2" ?
                                (<div className="w-full border-r-2 border-sky-600">
                                    <div className="hover:text-black !text-black min-w-min w-3/4 flex flex-row justify-start gap-4 align-center rounded-lg bg-[#EFF2FE] p-3 ">
                                        <div className="!text-xl"><ImClipboard /></div>
                                        <Link to="/report2" >Service Dashboard</Link>
                                    </div></div>) :
                                (<div className="hover:text-black w-3/4 flex flex-row justify-start gap-4 align-center rounded-lg p-3 ">
                                    <div className="!text-xl"><ImClipboard /></div>
                                    <Link to="/report2" >Service Dashboard</Link>
                        ...
                        (<Link to="/projects" className="shrink-0"> <img src={timechart} alt="company logo" className="w-10 h-auto my-2 shrink-0  p-1" /></Link>)} */}
                            ...
                            {route === "/report" ?
                                (<Link to="/report" className="shrink-0"><img src={report} alt="company logo" className="w-10 h-auto my-2 shrink-0  p-1 border-[#c3c3c3] border-2 w-12" /></Link>) :
                                (<Link to="/report" className="shrink-0"><img src={report} alt="company logo" className="w-10 h-auto my-2 shrink-0  p-1" /></Link>)}

                            {route === "/report2" ?
                                (<Link to="/report2" className="shrink-0"><img src={report} alt="company logo" className="w-10 h-auto my-2 shrink-0  p-1 border-[#c3c3c3] border-2 w-12" /></Link>) :
                                (<Link to="/report2" className="shrink-0"><img src={report} alt="company logo" className="w-10 h-auto my-2 shrink-0  p-1" /></Link>)}
