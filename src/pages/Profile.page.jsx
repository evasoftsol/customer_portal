            ...
            <div className='hidden sm:block h-5/6 sm:h-5/6 overflow-y-auto '>
                ...
                <div className='flex flex-col gap-2  ml-10'>
                    ...
                    <div className=" sm:flex sm:flex-col rounded-lg bg-white w-11/12 sm:w-11/12" >
                        <div className='pt-10 pb-5 flex'><span className='font-semibold px-5 w-2/12'>ID: </span>{localStorage.getItem("customerId")}</div>
                        <div className='pb-5 flex'><span className='font-semibold px-5 w-2/12'>Name: </span>{localStorage.getItem("customerName")}</div>
